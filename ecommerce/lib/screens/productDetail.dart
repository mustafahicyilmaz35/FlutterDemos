                ...
                children: <Widget>[
                  TabBarView(
                    ...
                    children: <Widget>[
                      ...
                      Image.network(
                          "https://images-na.ssl-images-amazon.com/images/I/71hhAP8MK8L._UX385_.jpg")
                    ],
                  ),
                  Container(
    ...
    return Padding(
      ...
      child: Row(
        children: <Widget>[
          ...
          SizedBox(width: 12.0),
          Text("Daha Fazla Bilgi İçin Tıklayınız",
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: TabBarView(
              controller: tabController,
              children: <Widget>[
                Text("%60 Pamuk %30 Polyster",
                    style: TextStyle(color: Colors.black)),
                Text("30 Derecede makinede renkli yıkama",
                    style: TextStyle(color: Colors.black))
              ],
            ),
          )
